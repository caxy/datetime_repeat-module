...
<head>
	...
	<link href="dist/css/fuelux-dev.css" rel="stylesheet" type="text/css">
	<link href="index.css" rel="stylesheet" type="text/css">
	<link href="//www.fuelcdn.com/fuelux-mctheme/1.13.1/css/fuelux-mctheme.min.css" rel="stylesheet">
	...
	<form>
		<div class="container" id="mainWrapper">
			<section id="checkboxes">
				<h2>Checkboxes</h2>
				<div class="thin-box">
					<section id="checkboxes-block" style="width: 20rem;">

						<div class="checkbox" id="myCheckbox">
							<label class="checkbox-custom" data-initialize="checkbox" id="myCustomCheckbox1">
								<input class="sr-only" type="checkbox" value="">
								<span class="truncate checkbox-label">Custom checkbox unchecked on page load</span>
							</label>
						</div>
						<div class="checkbox" id="myCheckbox2">
							<label class="checkbox-custom checked" data-initialize="checkbox" id="myCustomCheckbox2">
								...
								<span class="truncate checkbox-label">Custom checkbox checked on page load</span>
							</label>
						</div>
						<div class="checkbox" id="myCheckbox3">
							<label class="checkbox-custom" data-initialize="checkbox" id="myCustomCheckbox3">
								...
								<span class="truncate checkbox-label">Disabled custom checkbox unchecked on page load</span>
							</label>
						</div>
						<div class="checkbox" id="myCheckbox4">
							<label class="checkbox-custom checked disabled" data-initialize="checkbox" id="myCustomCheckbox4">
								...
								<span class="truncate checkbox-label">Disabled custom checkbox checked on page load</span>
							</label>
						</div>
					</section>
				...
				<div class="thin-box">
					...
					<div class="radio">
						<label class="radio-custom" data-initialize="radio" id="myCustomRadio1">
							...
							<span class="truncate radio-label">Custom radio unchecked on page load</span>
						</label>
					</div>
					<div class="radio">
						<label class="radio-custom" data-initialize="radio" id="myCustomRadio2">
							...
							<span class="truncate radio-label">Custom radio checked on page load</span>
						</label>
					</div>
					<div class="radio">
						<label class="radio-custom" data-initialize="radio" id="myCustomRadio3">
							...
							<span class="truncate radio-label">Custom radio disabled and unchecked on page load</span>
						</label>
					</div>
					<div class="radio">
						<label class="radio-custom" data-initialize="radio" id="myCustomRadio4">
							...
							<span class="truncate radio-label">Custom radio disabled and checked on page load</span>
						</label>
					</div>
			...
			<section id="tree">
				...
				<div class="thin-box">
					...
					<div id="myTreeWrapper" class="truncate"></div>
			...
			<section id="truncate">
				<h2>Truncate</h2>
				<div class="thin-box">
					<section id="truncate-single-line" style="width: 30rem;">
						<p class="truncate" title="Long text field with many lines and truncation will look like this. Even though the text might go on for ages and ages.">
